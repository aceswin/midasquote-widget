  ...
  const MQ_HELP_CONTENT = {
    ...
    pricing: {
      ...
      body: `
        ...
        <p><strong>Category is locked once an item is created</strong>, since its pricing method depends on it. Box Materials and Drawer Configurations also lock their Name (they're matched to their paired row by that exact name), and so do Installation & Removal rates, which the widget looks up by name.</p>
        <p><strong>Unit (pricing method) locks after creation</strong> too — except Travel Zone, which can still switch between km and mi any time via Edit.</p>
