...
(function() {
  ...
  const CATEGORIES = [
    ...
    { id:'hinge',    label:'🔧 Door hinges',             sub:'Pre-added — Hinge options you offer — your cheapest hinge is the baseline, others become upcharges. Most shop only need these pre-added options.', placeholder:'e.g. Concealed hinge' },
