...
(function() {
  ...
  const CATEGORIES = [
    ...
    { id:'door',     label:'🚪 Door styles',             sub:sub:'Think species and profile — maple shaker, oak raised panel, MDF slab, and so on. Unless you charge significantly more for one finish over another, you don\'t need a separate item for each finish. Keep it to your most popular styles.', placeholder:'e.g. Maple shaker' },
