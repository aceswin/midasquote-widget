        ...
        if (!localStorage.getItem(storageKey)) {
          ...
          popup.innerHTML = `
            <div style="background:#fff;border-radius:16px;max-width:400px;width:100%;padding:2rem;text-align:center;box-shadow:0 24px 60px rgba(0,0,0,0.25);animation:mqSlideUp 0.3s ease">
              ...
              <button onclick="mqDismissTipsPopup()" style="background:none;border:none;font-size:13px;color:#9ca3af;cursor:pointer;font-family:inherit;padding:4px">Maybe later</button>
            </div>
            <style>
    ...
    window.mqShowHomeScreenStep = function(which) {
      ...
      if (which === 'picker') {
        modal.innerHTML = `<div style="background:#fff;border-radius:16px;max-width:380px;width:100%;padding:2rem;text-align:center;box-shadow:0 24px 60px rgba(0,0,0,0.25)">
          ...
          <div style="font-size:13px;color:#6b7280;margin-bottom:1.5rem">What are you using right now?</div>
          ...
          <button onclick="mqCloseHomeScreenModal()" style="margin-top:1.25rem;background:none;border:none;font-size:13px;color:#9ca3af;cursor:pointer;font-family:inherit">Close</button>
        </div>`;
        return;
      }
      ...
      if ((which === 'android' || which === 'desktop') && _mqDeferredInstallPrompt) {
        modal.innerHTML = `<div style="background:#fff;border-radius:16px;max-width:380px;width:100%;padding:2rem;text-align:center;box-shadow:0 24px 60px rgba(0,0,0,0.25)">
          ...
          <button onclick="mqShowHomeScreenStep('picker')" style="background:none;border:none;font-size:13px;color:#9ca3af;cursor:pointer;font-family:inherit">Back</button>
        </div>`;
        return;
      }
      ...
      modal.innerHTML = `<div style="background:#fff;border-radius:16px;max-width:380px;width:100%;padding:2rem;box-shadow:0 24px 60px rgba(0,0,0,0.25)">
        ...
        <button onclick="mqCloseHomeScreenModal()" style="display:block;width:100%;background:none;border:none;font-size:13px;color:#9ca3af;cursor:pointer;font-family:inherit">Close</button>
      </div>`;
    };
