...
//This is the widget test file
  ...
  async function loadShopData(token) {
    ...
    if (!Array.isArray(roomTypes) || !roomTypes.length) {
      roomTypes = [
        { id:'kitchen', name:'Kitchen',        adjustment:0,  description:'The kitchen is where life happens — let\'s build one you\'ll love spending time in. Pick your cabinets, doors, and finishes, and watch your dream kitchen take shape.', active:true, coverImage:'', measureImage:'https://aceswin.github.io/midasquote-widget/measure-guides/kitchen.png' },
        { id:'bathroom',name:'Bathroom',       adjustment:-5, description:'Turn your bathroom into a personal retreat. Choose the vanity and finishes that make getting ready each morning feel a little more special.', active:true, coverImage:'', measureImage:'https://aceswin.github.io/midasquote-widget/measure-guides/bathroom.png' },
        { id:'laundry', name:'Laundry room',   adjustment:0,  description:'Even the laundry room deserves some love. Add smart, good-looking storage that makes everyday chores feel a lot less like chores.', active:true, coverImage:'', measureImage:'https://aceswin.github.io/midasquote-widget/measure-guides/laundry.png' },
        { id:'garage',  name:'Garage',         adjustment:0,  description:'From tools to hobbies to overflow storage — give your garage the organized, great-looking upgrade it\'s been waiting for.', active:true, coverImage:'', measureImage:'https://aceswin.github.io/midasquote-widget/measure-guides/garage.png' },
        { id:'commercial', name:'Commercial',  adjustment:0,  description:'Make a great first impression. Get cabinetry built to fit your business, whether it\'s a sleek office or a welcoming retail space.', active:true, coverImage:'', measureImage:'https://aceswin.github.io/midasquote-widget/measure-guides/commercial.png' },
        { id:'other',   name:'Other',          adjustment:0,  description:'Got a project that doesn\'t quite fit the mold? We love a good challenge — let\'s bring your vision to life.', active:true, coverImage:'', measureImage:'https://aceswin.github.io/midasquote-widget/measure-guides/other.png' },
